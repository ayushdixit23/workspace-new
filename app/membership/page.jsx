...
const Sample5 = () => {
	...
	return (
		<>
			...
			{
				memberPop && <div className="fixed inset-0 w-screen z-50 flex justify-center font-semibold text-sm text-[#101828] dark:text-white items-center h-screen bg-black/50">
			...
			<div className="bg-white dark:bg-[#273142] min-h-[100vh] no-scrollbar flex items-center justify-center">
				<div className="sm:mx-5 mx-2 pb-10">
					{/* Ai */}
					<div className="py-2 lg:py-2 mt-8 flex flex-col w-full dark:text-white  text-[#101828]">
						...
						{/* <div className="flex gap-2 p-2 mt-2 text-red-300 justify-between  bg-[#f9f9f9] px-4 relative shadow-lg shadow-white-500/5 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 ring-1 ring-[#f4f4f452]  items-center rounded-2xl">
							...
							<div className="px-2 py-2 bg-[#F2F4F7] space-x-1 flex justify-center items-center rounded-full">
								<button
									onClick={() => setAi(true)}
									className={`py-2 px-2 md:px-1.5 sm:px-6 drop-shadow-md hover:bg-white dark:bg-[#273142] text-[#667085] hover:text-black rounded-full
                ${ai && "bg-white dark:bg-[#273142] border-[#94a3b8] border text-black "}`}
								>

								</button>
								<button
									onClick={() => setAi(false)}
									className={`ml-1 py-2 px-2 md:px-1.5 sm:px-6 border-[#94a3b8] drop-shadow-md hover:bg-white dark:bg-[#273142] text-[#667085]  hover:text-black rounded-full
                ${!ai && "bg-white dark:bg-[#273142] border-[#94a3b8] border text-black"}`}
								>
						...
						<div className="flex gap-2 p-2 mt-2 text-red-300 justify-between  bg-[#f9f9f9] px-4 relative shadow-lg shadow-white-500/5 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 ring-1 ring-[#f4f4f452]  items-center rounded-2xl">
							<div className="flex justify-center py-3 gap-3 items-center">
								...
								<div className="flex flex-col justify-center">
									<div className="font-medium text-base dark:text-white text-[#101828] ">Want to deliver your Products?</div>
									<div className="font-medium dark:text-white text-[#060a11] text-sm">Get upto 10 deliveries free  </div>
								</div>
                ...
                ${isdelivery === false ? "bg-white dark:bg-[#273142] border-[#94a3b8] border text-black " : ""}`}
								>
                ...
                ${isdelivery === true ? "bg-white dark:bg-[#273142] border-[#94a3b8] border text-black" : ""}`}
								>
					...
					<div className="flex justify-center mt-6 items-center w-full">
						<div className="grid xl:grid-cols-5 gap-10 sm:gap-5 xl:gap-0 sm:grid-cols-2 w-full">
							<div className="xl:block hidden">
								<div>
									<div className="h-[150px] px-2 font-semibold text-sm  border border-[#E6E9F5] flex justify-start z-20 bg-white dark:bg-[#273142] sticky top-0 left-0  items-center
									">
									...
									{isdelivery && <div className="flex font-bold px-4 text-lg text-[#101828] dark:text-white items-center h-[50px]">
										Deliveries
									</div>}
									{isdelivery && <div>
										<div className="flex border border-[#E6E9F5] px-4 font-semibold text-sm text-[#101828] dark:text-white items-center h-[50px]">
											Deliveries (all over the city)
										</div>
										<div className="flex border border-[#E6E9F5] px-4 font-semibold text-sm text-[#101828] dark:text-white items-center h-[70px]">
											Delivery Options (all over the country)
										</div>

									</div>}
									<div className="flex font-bold px-4 text-lg text-[#101828] dark:text-white items-center h-[50px]">
										Badge
									</div>
									<div>
										<div className="flex border border-[#E6E9F5] px-4 font-semibold text-sm text-[#101828] dark:text-white items-center h-[50px]">
							...
							<div className="md:max-lg:min-w-[450px]">
								<div>
									<div className="h-[150px] px-2 border border-[#E6E9F5] flex justify-start z-20 bg-white dark:bg-[#273142] sticky top-0 left-0 items-center
									">
									...
									{isdelivery && <div>
										<div className="flex border flex-col border-[#E6E9F5] px-4 font-semibold text-sm text-[#101828] dark:text-white justify-center h-[50px]">
							...
							<div className="md:max-lg:min-w-[450px]">
								<div>
									...
									{isdelivery && <div>
										<div className="flex border flex-col border-[#E6E9F5] px-4 font-semibold text-sm text-[#101828] dark:text-white h-[50px]">
											...
											<div className="flex h-full">
												<form className="max-w-xs flex items-center gap-2">
													...
													<div className="relative flex items-center">
														...
														<input type="text" id="counter-input" data-input-counter className="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder="" value={d.plus} required />
														<button onClick={() => handlePlus("plus", 10)} type="button" id="increment-button" data-input-counter-increment="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
										...
										<div className="flex border flex-col border-[#E6E9F5] px-4 font-semibold text-sm text-[#101828] dark:text-white h-[70px]">
											...
											<div className="flex h-full">
												<form className="max-w-xs flex items-center gap-2">
													<label htmlFor="counter-input" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Choose quantity:</label>
													<div className="relative flex items-center">
														<button onClick={() => handleMinusdc("plus", 10)} type="button" id="decrement-button" data-input-counter-decrement="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
															<svg className="w-2.5 h-2.5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 2">
																<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h16" />
															</svg>
														</button>
														<input type="text" id="counter-input" data-input-counter className="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder="" value={dc.plus} required />
														<button onClick={() => handlePlusdc("plus", 10)} type="button" id="increment-button" data-input-counter-increment="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
															<svg className="w-2.5 h-2.5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
																<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 1v16M1 9h16" />
															</svg>
														</button>
										...
										<div className="flex border flex-col border-[#E6E9F5] px-4 font-semibold text-sm text-[#101828] dark:text-white h-[50px]">
											...
											<div className="flex h-full">
												<form className="max-w-xs flex items-center gap-2">
													<label htmlFor="counter-input" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Choose quantity:</label>
													<div className="relative flex items-center">
														<button onClick={() => handleMinus("pro", 10)} type="button" id="decrement-button" data-input-counter-decrement="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
															<svg className="w-2.5 h-2.5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 2">
																<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h16" />
															</svg>
														</button>
														<input type="text" id="counter-input" data-input-counter className="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder="" value={d.pro} required />
														<button onClick={() => handlePlus("pro", 10)} type="button" id="increment-button" data-input-counter-increment="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
															<svg className="w-2.5 h-2.5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
																<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 1v16M1 9h16" />
															</svg>
														</button>
										...
										<div className="flex border flex-col border-[#E6E9F5] px-4 font-semibold text-sm text-[#101828] dark:text-white h-[70px]">
											...
											<div className="flex h-full">
												<form className="max-w-xs flex items-center gap-2">
													<label htmlFor="counter-input" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Choose quantity:</label>
													<div className="relative flex items-center">
														<button onClick={() => handleMinusdc("pro", 10)} type="button" id="decrement-button" data-input-counter-decrement="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
															<svg className="w-2.5 h-2.5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 2">
																<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h16" />
															</svg>
														</button>
														<input type="text" id="counter-input" data-input-counter className="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder="" value={dc.pro} required />
														<button onClick={() => handlePlusdc("pro", 10)} type="button" id="increment-button" data-input-counter-increment="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
															<svg className="w-2.5 h-2.5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
																<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 1v16M1 9h16" />
															</svg>
														</button>
										...
										<div className="flex border flex-col border-[#E6E9F5] px-4 font-semibold text-sm text-[#101828] dark:text-white h-[50px]">
											...
											<div className="flex h-full">
												<form className="max-w-xs flex items-center gap-2">
													<label htmlFor="counter-input" className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Choose quantity:</label>
													<div className="relative flex items-center">
														<button onClick={() => handleMinus("premium", 10)} type="button" id="decrement-button" data-input-counter-decrement="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
															<svg className="w-2.5 h-2.5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 2">
																<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h16" />
															</svg>
														</button>
														<input type="text" id="counter-input" data-input-counter className="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder="" value={d.premium} required />
														<button onClick={() => handlePlus("premium", 10)} type="button" id="increment-button" data-input-counter-increment="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
															<svg className="w-2.5 h-2.5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
																<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 1v16M1 9h16" />
															</svg>
														</button>
											...
											<div className="flex h-full">
												<form className="max-w-xs flex items-center gap-2">
													...
													<div className="relative flex items-center">
														...
														<input type="text" id="counter-input" data-input-counter className="flex-shrink-0 text-gray-900 dark:text-white border-0 bg-transparent text-sm font-normal focus:outline-none focus:ring-0 max-w-[2.5rem] text-center" placeholder="" value={dc.premium} required />
														<button onClick={() => handlePlusdc("premium", 10)} type="button" id="increment-button" data-input-counter-increment="counter-input" className="flex-shrink-0 bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 inline-flex items-center justify-center border border-gray-300 rounded-md h-5 w-5 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
															<svg className="w-2.5 h-2.5 text-gray-900 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
																<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 1v16M1 9h16" />
															</svg>
														</button>
