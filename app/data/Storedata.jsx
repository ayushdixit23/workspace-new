  ...
  return (
    <div className={`flex flex-col gap-4`}>
      <div className="bg-white dark:text-white dark:bg-[#273142] rounded-xl p-2 px-3">
        <div className="text-[#030229] dark:text-white font-semibold pt-2 px-2">
          Store Analytics
        </div>
...

        {
          getorderdata?.storeexistornot ? (getorderdata?.isStoreVerified ? <div className="w-full relative -left-10 pp:-left-8 sm:-left-6 top-2">
            {salesData.length > 0 ? salesData.length > 6 ? <ChartsStore data={salesData} /> : <div className="h-[200px] w-full flex text-2xl text-center font-semibold justify-center items-center">No Data To Show</div> : <div className="h-[200px] w-full flex text-2xl text-center font-semibold justify-center items-center">Data will be available after 7 days</div>}
          </div>
            :
            ...
            <div className="w-full h-auto sm:h-[470px] flex flex-col justify-center items-center">
              ...
              <div className="py-2 w-full text-[20px] flex sm:text-2xl text-center font-semibold justify-center items-center">Get Ready To Create Your Store</div>
              <Link
                href={"/main/store"}
...

      {
        getorderdata?.mergedOrder.length == 0 ? (
          ...
          <Link href={"/main/order"} className="w-full rounded-xl dark:bg-[#273142] bg-white sm:max-h-[200px] max-w-full overflow-y-scroll no-scrollbar sm:min-h-[200px] ">
