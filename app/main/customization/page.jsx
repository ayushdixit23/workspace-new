...
import { useDefaultPrositeMutation, useDeleteRecentPrositesMutation, useFetchValueQuery } from '@/app/redux/apiroutes/prosite'
...
const page = () => {
	...
	return (
		<>
			<Toaster />
			<div className={`${showDelete ? "fixed inset-0 w-screen z-50 bg-black/60 h-screen flex justify-center items-center backdrop-blur-md" : "hidden -z-50"}`}>
				<div className="flex justify-center items-center w-[90%] pp:w-[65%] sm:max-w-[500px] dark:text-white lg:w-[30%] p-3 rounded-xl dark:bg-[#273142] bg-white">
					<div className="flex flex-col flex-grow gap-3 justify-center items-center w-full">
						...
						<div className="flex justify-center w-full gap-3 items-center">
							<button onClick={() => { setShowDelete(false), dispatch(LoadThis(false)) }} className="w-full border-2 dark:border-white p-2 px-5 rounded-xl">Cancel</button>
							<button onClick={() => { setShowDelete(false), deleteRecentProsites(), dispatch(LoadThis(false)) }} className="w-full bg-[#f44336] text-white p-2 px-5 rounded-xl">Delete</button>
						</div>
					</div>
				...
				<div className='grid pn:max-sm:mb-[3%] grid-cols-1 mt-5 px-5 w-full'>
					...
					{data?.recentProsites?.length > 0 &&
						< div className='flex flex-col gap-2 w-full'>
							<div className='relative top-3 font-semibold'>Recent Prosite{data?.recentProsites?.length > 1 ? "s" : null}</div>
							<div className='flex gap-4 w-full overflow-x-scroll no-scrollbar max-w-full'>
								<div className='flex gap-4 w-full my-4'>
									{data?.recentProsites.map((d, i) => {
										...
										const url = `https://prosite.grovyo.com/lwozxip?id=${encodeURIComponent(id)}&addData=true&temp=${d?.template}&data=${encodeURIComponent(JSON.stringify(jsonData))}`;

										return (
											<div key={i} className="pm:max-pp:max-w-[275px] z-0 min-w-[275px] group w-full relative sm:max-w-[300px] flex flex-col bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
												<Image src={d?.canvasImage} width={500} height={500} className='rounded-t-lg pm:max-pp:max-w-[275px] h-[150px] w-full object-contain dark:bg-black' />
												<div className='absolute group-hover:block hidden right-0 -top-4 z-20' onClick={() => { setShowDelete(true), dispatch(LoadThis(true)), setPrositeId(d?._id) }}>
							...
							<div className='grid grid-cols-2 sm:grid-cols-3 gap-4 md:grid-cols-4 w-full'>
								...
								<div className="pm:max-pp:max-w-[275px] flex flex-col bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
									...
									<div className="p-2 flex pp:flex-row flex-col justify-between items-center px-2">
										...
										<a target='_blank' href={`https://prosite.grovyo.com/lwozxip?id=${encodeURIComponent(id)}&temp=1&addData=false`} className="inline-flex mt-2 pn:max-pp:w-full justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
											Use
										</a>
									</div>
								</div >
								...
								<div className="pm:max-pp:max-w-[275px] bg-white border flex flex-col border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
									...
									<div className="p-2 flex pp:flex-row flex-col justify-between px-2 items-center">
										...
										<a target='_blank' href={`https://prosite.grovyo.com/lwozxip?id=${encodeURIComponent(id)}&temp=2&addData=false`} className="inline-flex mt-2 pn:max-pp:w-full justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
											Use
								...
								<div className="pm:max-pp:max-w-[275px] bg-white border flex flex-col border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
									...
									<div className="p-2 flex pp:flex-row flex-col justify-between px-2 items-center">
										...
										<a target='_blank' href={`https://prosite.grovyo.com/lwozxip?id=${encodeURIComponent(id)}&temp=3&addData=false`} className="inline-flex mt-2 pn:max-pp:w-full justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
											Use
								...
								<div className="pm:max-pp:max-w-[275px] bg-white border flex flex-col border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
									...
									<div className="p-2 flex pp:flex-row flex-col justify-between px-2 items-center">
										...
										<a target='_blank' href={`https://prosite.grovyo.com/lwozxip?id=${encodeURIComponent(id)}&temp=4&addData=false`} className="inline-flex mt-2 pn:max-pp:w-full justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
											Use
								...
								<div className="pm:max-pp:max-w-[275px] bg-white border flex flex-col border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
									...
									<div className="p-2 flex pp:flex-row flex-col justify-between px-2 items-center">
										...
										<a target='_blank' href={`https://prosite.grovyo.com/lwozxip?id=${encodeURIComponent(id)}&temp=5&addData=false`} className="inline-flex mt-2 pn:max-pp:w-full justify-center items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
											Use
