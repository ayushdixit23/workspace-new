...
function Dashboard() {
  ...
  if (!id && !loading && !isLoading) {
    return <div class="fixed flex justify-center items-center w-screen h-screen inset-0 z-50 overflow-y-auto">
      <div class="flex min-h-full justify-center p-4 text-center items-center sm:p-0">
        ...
        <div class="relative transform overflow-hidden rounded-lg bg-white dark:bg-[#273142] text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
          <div class="bg-white dark:bg-[#273142] px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              ...
              <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                <h3 class="text-base font-semibold leading-6 " id="modal-title">Session Expired</h3>
                <div class="mt-2">
                  <p class="text-sm text-gray-500">Refresh the page or Log in Again!</p>
                </div>
              </div>
            </div>
          </div>
          <div class="bg-white dark:bg-[#273142] px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            ...
            }} type="button" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Log in</button>
            <button onClick={() => window.location.reload()} type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">Refresh</button>
          </div>
        </div>
      </div>
    </div>
      ...
      {analyticsdata?.commerged.length <= 0 && (
        <div>
          ...
          <div>
            ...
            {change == "store" && (
              <>
                {(getorderdata?.storeexistornot == false && getorderdata?.isStoreVerified === false) && < div className="flex flex-col justify-center items-center w-full h-[70vh] sm:h-[70vh]">
                  <div className="sm:w-auto h-full flex flex-col w-[90%] justify-center gap-4">
                    <div className="text-[#70737D] font-semibold">
                              ...
                              <div className="flex text-sm flex-col gap-3">
                                <div className="px-2 flex flex-col gap-1">
                                  ...
                                  <div className="w-full h-3 relative overflow-hidden min-w-[100px] bg-[#F8F8FF] rounded-full">
                                    <div style={{ width: analyticsdata.commerged.length >= 1 ? "100%" : 0 }} className="absolute top-0 left-0 rounded-r-xl  bg-[#40CAB0] h-full "></div>
                                  </div>
                                </div>
                                <div className="px-2 flex flex-col gap-1">
                                  <div className="flex justify-between items-center">
                                    ...
                                    <div className="">{analyticsdata?.posts}/1</div>
                                  </div>
                                  <div className="w-full h-3 relative overflow-hidden min-w-[100px] bg-[#F8F8FF] rounded-full">
                                    <div style={{ width: analyticsdata.posts >= 1 ? "100%" : 0 }} className="absolute top-0 left-0 rounded-r-xl  bg-[#40CAB0] h-full "></div>
                                  </div>
                                </div>
                              </div>
...

      {
        analyticsdata?.commerged.length > 0 && (
          <div className="grid grid-cols-1 w-full pn:max-sm:pb-20 h-auto">
            ...
            {(change == "store" && getorderdata?.storeexistornot && getorderdata?.isStoreVerified == false) && (
