				...
				<div className="flex flex-col h-full justify-center p-2 items-center">
					...
					<div className="sm:h-[60px] sm:mt-1 mt-3 h-[40px] pp:w-[230px] w-[200px] rounded-2xl relative flex justify-center items-center">
						<Lottie
							...
							loop={true}
						/>
						<div onClick={() => { setPop(true) }} className="py-2  text-[14px] cursor-pointer flex justify-center font-semibold items-center gap-1 px-2.5 sm:px-5 absolute text-black rounded-2xl ">
							{buttontext}
						</div>
					</div>
				</div>
